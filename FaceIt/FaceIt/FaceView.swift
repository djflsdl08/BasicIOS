...
class FaceView: UIView {
    ...
    @IBInspectable
    var mouthCurvature : Double = 1.0 { didSet { setNeedsDisplay() } }   // 1.0 : full smile, -1 : full frown
    @IBInspectable
    var eyesOpen : Bool = true { didSet { setNeedsDisplay() } }
    @IBInspectable
    var eyeBrowTilt : Double = 1.0  { didSet { setNeedsDisplay() } } // 1.0 : fully relaxed, -1 : full furrow
    @IBInspectable
    ...
    private func getEyeCenter(eye : Eye) -> CGPoint {
        ...
        eyeCenter.y -= eyeOffset       // y -= : up, y += : down
