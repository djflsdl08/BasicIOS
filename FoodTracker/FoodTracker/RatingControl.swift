...
@IBDesignable class RatingControl: UIStackView {
    ...
    //MARK: Properties
    private var ratingButtons = [UIButton]()    // contains the list of buttons
    var rating = 0 {
        didSet {
    ...
    private func setupButtons() {
        ...
        for index in 0..<starCount {    // this range goes from 0 to 4
            let button = UIButton() // Create the button
            /*
            button.backgroundColor = UIColor.red    // easy to see
            */
